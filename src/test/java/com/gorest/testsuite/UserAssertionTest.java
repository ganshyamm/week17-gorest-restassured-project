...
//3.Check the single ‘Name’ in the Array list (Aryan Panicker)

    @Test
    public void test003() {
        response.body("name", hasItem("Aryan Panicker"));
    }
//4.Check the multiple ‘Names’ in the ArrayList (Aryan Panicker, Chitraksh Devar)

    @Test
    public void test004() {
        response.body("name", hasItems("Aryan Panicker",
                "Chitraksh Devar"));
...
//6.Verify the status is “Active” of user name is “Goswamee Tandon”
    ...
    //7.Verify the Gender = male of user name is “Chandi Deshpande”
    @Test
    public void test007() {
        response.body("find{it.name == 'Chandi Deshpande'}.gender", equalTo("male"));
